...
$.ajax({
    type : "GET",
    url : "map/restaurantMap",
    data:{
        name:"${ulsan_restaurant.name}",
        lat:"${ulsan_restaurant.latitude}",
        lon:"${ulsan_restaurant.longitude}",
        address:"${ulsan_restaurant.address}",
        division:"${ulsan_restaurant.division}"
    },
